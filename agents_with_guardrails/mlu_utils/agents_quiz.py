...
lab1_question2 = Quiz(
    question={
        "question": "If you were developing a conversational bot for customer service, which module would be best suited for the task?",
        "options": [
            "ChatPromptTemplate",
            "ModelLaboratory",
            "OutputParser",
